                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-content py-5">
                            <div class="section-title text-start">
                                <span class="short-title wow fadeInUp text-white">BUISNESS LOAN</span>
                                <h1 class="text-white" data-wow-delay='0.2s'>Get your dream Buisness with low rates and flexible terms</h1>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="desc-text pl-lg-10">
                                <p>Our journey in providing Buisness loan services started with a commitment to help you achieve your dream of buisness. Since our inception, we have been dedicated to connecting individuals and families with the possibilities of owning a home.</p>
                                <p class="mt-20">At DFin, we understand the importance of a Buisness and the financial journey that comes with it. Our core banking services are tailored to offer flexible and affordable Buisnessloan options. Whether you are a first-time homebuyer or looking to refinance, we are here to guide you through the process.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="section-title">
                            <h2 class="wow fadeInUp">Key Features of DFin Buisness Loans</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.3s">Explore the features that make our Buisness loan services convenient and secure for you.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-30 gy-4">
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="0.1s">
                            <img src="img/home_loan/icon-11.svg" alt="icon">
                            <h4 class="mt-30 mb-15">Flexible Loan Terms</h4>
                            <p>Choose from a range of flexible loan terms that suit your financial needs and goals.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p>Benefit from competitive and affordable interest rates tailored for your Buisness financing.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="0.5s">
                            <img src="img/home_loan/icon-13.svg" alt="icon">
                            <h4 class="mt-30 mb-15">Security & Protection</h4>
                            <p>Rest assured with our robust security measures to protect your financial information.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="0.7s">
                            ...
                            <p>Access your Buisness loan details and make transactions conveniently with our mobile application.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="0.9s">
                            ...
                            <p>Apply for a Buisness loan online with our easy and streamlined application process.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="feature-card-widget-5 wow fadeInUp" data-wow-delay="1.1s">
                            ...
                            <p>Experience transparency with clear communication and minimal fees for our Buisness loan services.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="why-choose-area pt-125 pb-135 overflow-hidden">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="section-title">
                            <h2 class="wow fadeInUp">Why Choose DFin Buisness Loans?</h2>
                            <p class="wow fadeInUp text-white" data-wow-delay="0.3s">Discover the reasons to choose DFin for your Buisness loan needs.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-55 gy-lg-0 gy-4">
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <p>Our Buisness loan application process is designed to be user-friendly, making it easy for you to apply and navigate through the entire process.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="line-shape">
                                <img class="wow zoomIn" data-wow-delay="0.1s" src="img\how-works\line-shape.png" alt="shape">
                            </div>
                            <img src="img\how-works\salary (1).svg" alt="icon">
                            <h4 class="mt-30 mb-15">Quick Approval & Disbursement</h4>
                            <p>Experience faster approval and disbursement processes, ensuring that you get the funds you need for your dream Buisness without delays.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <p>Your financial security is our priority. Benefit from 100% secure transactions and data 
                                protection throughout your Buisness loan journey with DFin.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="cta-content text-black wow fadeInRight">
                    <h2>Unlock Your Dream Buisness with DFin</h2>
                    <p>Explore our Buisness loan options and take the first step towards buisness with DFin. Access flexible terms, competitive rates, and a seamless application process.</p>
                </div>
            </div>
            <div class="col-md-6 ">
                <div class="cta-content mt-3 mt-sm-0 text-sm-end text-center">
                    <a href="contact.php" class="theme-btn wow fadeInLeft">Get Buisness Loan</a>
                </div>
            </div>
        </div>
    </div>
