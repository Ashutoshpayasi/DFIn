...
<body data-spy="scroll" data-offset="70">
    ...
    <main>
        ...
        <section class="banner-area-3 pt-90" id="banner_animation2">
            <div class="bg-slides">
                <div class="slide" data-parallax='{"x": 220, "y": 0, "rotateZ":0}'>
                    <img class="wow slideInRight" data-wow-delay='0.2s' src="img/banner/slide-shape-1.png" alt="img">
                </div>
                <div class="slide" data-parallax='{"x": 270, "y": 0, "rotateZ":0}'>

                    <img class="wow slideInRight" data-wow-delay='0.6s' src="img/banner/slide-shape-2.png" alt="img">
                </div>
                <div class="slide" data-parallax='{"x": 330, "y": 0, "rotateZ":0}'>

                    <img class="wow slideInRight" data-wow-delay='1.3s' src="img/banner/slide-shape-3.png" alt="img">
                </div>
            </div>
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-5 d-none d-lg-block position-relative">
                        <img class="person-img " src="img/banner/person-2.png" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="feature-calculator pt-120 pb-140 bg_white">
            <div class="container">
                <!-- Feature -->
                <div class="feature">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="feature-slider">
                                <div class="feature-card-widget-3 wow fadeInLeft  card-1" data-wow-delay="0.1s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-17.png" alt="shape">
                                        <img src="img/feature/shape-18.png" alt="shape">
                                        <img src="img/feature/shape-19.png" alt="shape">
                                        <img src="img/feature/shape-20.png" alt="shape">
                                    </div>
                                    <img src="img/feature/icon-8.svg" alt="icon">
                                    <span class="title">Mortgage</span>
                                    <h5>Got a <span> question about Mortgage Loan?</span></h5>
                                    <a href="#">Write to us</a>
                                </div>
                                <div class="feature-card-widget-3 wow fadeInLeft  card-2" data-wow-delay="0.3s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-21.png" alt="shape">
                                        <img src="img/feature/shape-22.png" alt="shape">
                                        <img src="img/feature/shape-23.png" alt="shape">
                                        <img src="img/feature/shape-24.png" alt="shape">
                                    </div>
                                    <img src="img/feature/icon-9.svg" alt="icon">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-3" data-wow-delay="0.5s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-25.png" alt="shape">
                                        <img src="img/feature/shape-26.png" alt="shape">
                                        <img src="img/feature/shape-27.png" alt="shape">
                                        <img src="img/feature/shape-28.png" alt="shape">
                                        <img src="img/feature/shape-28.png" alt="shape">
                                        <img src="img/feature/shape-29.png" alt="shape">
                                        <img src="img/feature/shape-29.png" alt="shape">
                                    </div>
                                    <img src="img/feature/icon-10.svg" alt="icon">
                                    <span class="title">Loans</span>
                                    <h5>Got a <span> question about Mortgage Loan?</span></h5>
                                    <a href="#">Write to us</a>
                                </div>
                                <div class="feature-card-widget-3 wow fadeInLeft  card-1" data-wow-delay="0.7s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-17.png" alt="shape">
                                        <img src="img/feature/shape-18.png" alt="shape">
                                        <img src="img/feature/shape-19.png" alt="shape">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-2" data-wow-delay="0.9s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-21.png" alt="shape">
                                        <img src="img/feature/shape-22.png" alt="shape">
                                        <img src="img/feature/shape-23.png" alt="shape">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-3" data-wow-delay="1.1s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-25.png" alt="shape">
                                        <img src="img/feature/shape-26.png" alt="shape">
                                        <img src="img/feature/shape-27.png" alt="shape">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-1" data-wow-delay="1.3s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-17.png" alt="shape">
                                        <img src="img/feature/shape-18.png" alt="shape">
                                        <img src="img/feature/shape-19.png" alt="shape">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-2" data-wow-delay="1.5s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-21.png" alt="shape">
                                        <img src="img/feature/shape-22.png" alt="shape">
                                        <img src="img/feature/shape-23.png" alt="shape">
                                ...
                                <div class="feature-card-widget-3 wow fadeInLeft  card-3" data-wow-delay="1.7s">
                                    <div class="shapes">
                                        <img src="img/feature/shape-25.png" alt="shape">
                                        <img src="img/feature/shape-26.png" alt="shape">
                                        <img src="img/feature/shape-27.png" alt="shape">
                ...
                <!-- Calculator -->
                <div class="calculator mt-60">
                    <div class="steps d-flex flex-wrap justify-content-between mt-50 mr-30 ml-30">
                    ...
                    <div class="row border-bottom gx-0 px-4">
                        <div class="col-lg-6 border-end ">
                            <div class="calculator-slider pt-40 pb-5 ps-md-4 pe-md-5 px-1">
                                ...
                                <span class="range">Min $5,000 - Max $250,000</span>
                            </div>

                        </div>
                        <div class="col-lg-6">
                            <div class="calculator-slider pt-40 pb-5 ps-md-4 ps-lg-5 pe-md-4 px-1">
                                <label class="label-2">Loan Period</label>
                                <div class="d-flex align-items-center">
                                    <div class="range-slider" id="SliderPeriod"></div>
                                    <input class="range-input" type="text" id="SetSliderPeriod">
                                </div>

                                <span class="range">Min 1 year - Max 5 years</span>
                            </div>
                        </div>
                    </div>
                    <div class="expected-payment mt-50 mr-30 ml-30 mb-50">
                        <div class="bg_disable d-flex justify-content-between flex-wrap sec-head align-items-center">
                            <div>
                                <h5>Expected monthly payment</h5>
                                <p>Based on 7% borrowing rate</p>
                            </div>
                            <h4 class="mb-0">$1,162 / month</h4>
                        </div>
                        <p class="text mx-sm-4 mt-20">Price example: Total credit amount USD $100,000 - Maturity 120
                            months
                            -
                            Variable
                            borrowing
                            rate 7% - APR 7.24% - Etb. USD $1,000 - Total repayment: USD $140,190 - Total credit costs:
                            USD $40,190 - 14-day right of withdrawal</p>

                        <div class="text-center mt-45">
                            <a href="loan-details.php" class="theme-btn theme-btn-rounded"> Next <i
        ...
        <section class="help-ad-area pt-125 pb-115 overflow-hidden">
            <div class="container">
                ...
                <div class="row pt-40">
                    <div class="col-lg-10 mx-auto">
                        <div class="row">
                            <div class="col-12">
                                <img class="main-img img-fluid" src="img/help-ad/img-1.png" alt="img">
                            </div>
                            <div class="col-lg-5">
                                <div class="offers">
                                    <ul>
                                        <li> <span><i class="icon_check"></i></span> Offers from several banks</li>
                                        <li> <span><i class="icon_check"></i></span> Free & no obligation </li>
                                        <li> <span><i class="icon_check"></i></span> Compare safely and securely</li>
                                        <li> <span><i class="icon_check"></i></span> Offer within a few hours</li>
                                    </ul>
                                    <div class="shape"> <img src="img/help-ad/shape.png" alt="shape"></div>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <p class="pt-lg-60">Compare multiple banks with just one non-binding application.
                                    We save you the hassle of checking the price at each bank.</p>
                                <p class="py-4">It takes 2 min. To fill out the application, you immediately get quotes
                                    from banks
                                    and can
                                    choose the best quote.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="section-title">
                            <h2 class="wow fadeInUp">Banca Cooperates With These Banks</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.3s"> <span>3000+ Companies</span> Trust
                                Sturtaplanding to build
                                landing page for their <span> dream product</span></p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-between mt-35 gy-sm-0 gy-4  text-center text-lg-start">
                    <div class="col-lg-2 col-6">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/banca-corporate/logo-1.png" alt="logo">
                        </a>
                    </div>
                    <div class="col-lg-2 col-6">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.3s">
                            <img class="img-fluid" src="img/banca-corporate/logo-2.png" alt="logo">
                        </a>
                    </div>
                    <div class="col-lg-2 col-6">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.5s">
                            <img class="img-fluid" src="img/banca-corporate/logo-3.png" alt="logo">
                        </a>
                    </div>
                    <div class="col-lg-2 col-6">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.7s">
                            <img class="img-fluid" src="img/banca-corporate/logo-4.png" alt="logo">
                        </a>
                    </div>
                    <div class="col-lg-2 col-6 d-none d-lg-block">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.9s">
                            <img class="img-fluid" src="img/banca-corporate/logo-5.png" alt="logo">
                        </a>
                    </div>

                </div>
                <div class="row justify-content-between gy-sm-0 gy-4 mt-20 text-center text-lg-start">
                    <div class="col-lg-2 col-6">
                        <a href="#" class="single-brand wow fadeInRight" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/banca-corporate/logo-1.png" alt="logo">
                        </a>
        ...
        <section class="articles-area pt-125 pb-140">
            <div class="container">
                <div class="section-title d-flex flex-wrap justify-content-between text-start align-items-center">
                    ...
                    <a class="wow fadeInLeft" href="blog.php">See All Articles <i class="arrow_right"></i></a>
                </div>
                <div class="row mt-60 gy-4 gy-lg-0">
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.1s">
                            <img class="w-100" src="img/blog/article-1.png" alt="news image">
                            <div class="blog-content pr-10 pl-10">
                                <h6><a href="blog-details.php">Credit rating as a private customer</a></h6>
                                <div class="blog-date">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.3s">
                            <img class="w-100" src="img/blog/article-2.png" alt="news image">
                            <div class="blog-content pr-10 pl-10">
                                <h6><a href="blog-details.php">Get hold of your private loans with a promissory</a>
                                </h6>
                                <div class="blog-date">
                                    <i class="icon_calendar"></i>
                                    <span>February 25, 2021</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.5s">
                            <img class="w-100" src="img/blog/article-3.png" alt="news image">
                            <div class="blog-content pr-10 pl-10">
                                <h6><a href="blog-details.php">What is APR and what can you actually use it?</a></h6>
                                <div class="blog-date">
                                    <i class="icon_calendar"></i>
                                    <span>February 25, 2021</span>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.7s">
                            <img class="w-100" src="img/blog/article-4.png" alt="news image">
                            <div class="blog-content pr-10 pl-10">
                                <h6><a href="blog-details.php">Superfast loans for your dream home</a></h6>
                                <div class="blog-date">
                                    <i class="icon_calendar"></i>
                                    <span>February 25, 2021</span>
                                </div>
        ...
        <!-- Testimonial start -->
        <section class="testimonial-area pt-135 pb-140 bg_white">
            <div class="container">
                        ...
                        <div class="testimonial-slider-3">
                            ...
                            <div class="testimonial-widget-3 wow fadeInLeft">
                                <div class="client-img">
                                    <img src="img/testimonial/client-4.png" alt="client">
                                    <a class="play-btn" data-fancybox
                                        href="https://www.youtube.com/watch?v=xcJtL7QggTI">
                                        <i class="fas fa-play"></i>
                                    </a>
                                    <p class="caption">Best service and smooth process. Keep going on Banca team. Thank
                                        you for immediate response on each stage of process. Kudos the whole team.</p>
                                </div>
                            ...
                            <div class="testimonial-widget-3 wow fadeInLeft">
                                <div class="client-img">
                                    <img src="img/testimonial/client-1.png" alt="client">
                                    <a class="play-btn" data-fancybox
                                        href="https://www.youtube.com/watch?v=xcJtL7QggTI">
                                        <i class="fas fa-play"></i>
                                    </a>
                            ...
                            <div class="testimonial-widget-3 wow fadeInLeft">
                                <div class="client-img">
                                    <img src="img/testimonial/client-2.png" alt="client">
                                    <a class="play-btn" data-fancybox
                                        href="https://www.youtube.com/watch?v=xcJtL7QggTI">
                                        <i class="fas fa-play"></i>
                                    </a>
                            ...
                            <div class="testimonial-widget-3 wow fadeInLeft">
                                <div class="client-img">
                                    <img src="img/testimonial/client-3.png" alt="client">
                                    <a class="play-btn" data-fancybox
                                        href="https://www.youtube.com/watch?v=xcJtL7QggTI">
                                        <i class="fas fa-play"></i>
                                    </a>
                    ...
                    <div class="col-lg-8 col-md-6 ">
                        <div class="h-100 d-flex flex-column justify-content-between">
                            <div class="section-title text-start d-none d-md-block">
                                <h2 class="wow fadeInRight">What Our Customers <br> Are Saying</h2>
                            </div>
                            <div class="testimonial-slider-2">
                                ...
                                <div class="testimonial-widget-2 wow fadeInUp" data-wow-delay="0.3s">
                                    <img src="img/testimonial/client-2.png" alt="client">
                                    <div class="client-info">
                                        <p>Sandra Hughes</p>
                                        <span>UI/UX Designer</span>
                                ...
                                <div class="testimonial-widget-2 wow fadeInUp" data-wow-delay="0.5s">
                                    <img src="img/testimonial/client-3.png" alt="client">
                                    <div class="client-info">
                                        <p>Zachary Taylo</p>
                                        <span>UI/UX Designer</span>
                                ...
                                <div class="testimonial-widget-2 wow fadeInUp" data-wow-delay="0.7s">
                                    <img src="img/testimonial/client-4.png" alt="client">
                                    <div class="client-info">
                                        <p>Linda Lawrence</p>
                                        <span>UI/UX Designer</span>
                ...
                <div class="row gy-4 gy-lg-0">
                    <div class="col-lg-6 pr-lg-75">
                        ...
                        <div class="advisor-img mt-45 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="shape ">
                                <div class="box">
                                    <img class="layer layer2" data-depth="0.5" src="img/faq/Shape.png" alt="shape">
                                </div>
                                <div class="circle-shape"></div>
                            </div>
                            <img class="main-img" src="img/faq/advisor.png" alt="advisor">
        ...
        <section class="help-cta pt-75 pb-90" style="background-image: url(img/help-ad/bg-shape.png);">
            <div class="container">
                <div class="section-title">
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto text-center">
                        ...
                        <p>Whether you need to borrow for renovation, car, holiday or want to combine your loans into
                            one single loan, we will help you</p>
                        <div class="mt-40">
                            <a href="loan.php" class="theme-btn theme-btn-rounded me-sm-4 mt-3 mt-sm-0">New Loan</a>
                            <a href="loan-details.php"
                                class="theme-btn theme-btn-rounded theme-btn-alt mt-3 mt-sm-0">Collective
                                Loan</a>
                        </div>
